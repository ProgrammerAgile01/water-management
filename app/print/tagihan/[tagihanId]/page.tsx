...
export default async function Page({ params, searchParams }: PageProps) {
  ...
  const compact = (searchParams?.compact ?? "") === "1"; // pakai compact untuk ringkas (satu layar)
  ...
  // ===== ambil catatMeter utk periode & pelanggan ini =====
  ...
  return (
    <div className="mx-auto text-zinc-900 bg-white">
      ...
      <style>{`
        ...
        /* Header hijau full bar */
        .headerBar{
          background: linear-gradient(135deg,var(--green1),var(--green2));
          color:#fff; padding:12pt 14pt; display:flex; align-items:center; gap:10pt;
        }
