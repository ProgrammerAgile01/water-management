...
//     (acc, item) => ({
//       tagihan: acc.tagihan + item.tagihan,
//       abonemen: acc.abonemen + item.abonemen,
//       totalTagihan: acc.totalTagihan + item.totalTagihan,
//       belumBayar: acc.belumBayar + item.belumBayar,
//     }),
//     { tagihan: 0, abonemen: 0, totalTagihan: 0, belumBayar: 0 },
//   )
...
//                   </SelectTrigger>
//                   <SelectContent>
//                     <SelectItem value="Juli 2025">Juli 2025</SelectItem>
//                     <SelectItem value="Agustus 2025">Agustus 2025</SelectItem>
...
//                     <th className="text-left py-3 px-2 font-medium text-muted-foreground">Moter Saat Pengecekan</th>
//                     <th className="text-left py-3 px-2 font-medium text-muted-foreground">Tagihan (mol)</th>
//                     <th className="text-left py-3 px-2 font-medium text-muted-foreground">Abonemen &lt; Tarif/mo</th>
//                     <th className="text-left py-3 px-2 font-medium text-muted-foreground">Total Tagihan</th>
//                     <th className="text-left py-3 px-2 font-medium text-muted-foreground">Belum Bayar</th>
//                   </tr>
//                 </thead>
//                 <tbody>
...
//                       <td className="py-4 px-2 text-sm font-medium">{item.nama}</td>
//                       <td className="py-4 px-2 text-sm">{item.meterSaatPengecekan}</td>
//                       <td className="py-4 px-2 text-sm">{item.tagihan}</td>
//                       <td className="py-4 px-2 text-sm">R{item.abonemen.toLocaleString("id-ID")}</td>
//                       <td className="py-4 px-2 text-sm">{item.totalTagihan.toLocaleString("id-ID")}</td>
//                       <td className="py-4 px-2 text-sm">{item.belumBayar > 0 ? item.belumBayar.toFixed(2) : "0.00"}</td>
//                     </tr>
//                   ))}
//                   {/* Total Row */}
//                   <tr className="border-t-2 border-primary/20 bg-muted/10 font-semibold">
//                     <td className="py-4 px-2 text-sm">Total</td>
//                     <td className="py-4 px-2 text-sm"></td>
//                     <td className="py-4 px-2 text-sm">Rp 87.000</td>
//                     <td className="py-4 px-2 text-sm">Rp {totals.tagihan}</td>
//                     <td className="py-4 px-2 text-sm">Rp{totals.abonemen.toLocaleString("id-ID")}</td>
//                     <td className="py-4 px-2 text-sm">Rp{totals.totalTagihan.toLocaleString("id-ID")}</td>
//                     <td className="py-4 px-2 text-sm">{totals.belumBayar.toFixed(3)}</td>
//                   </tr>
//                 </tbody>
//               </table>
//             </div>
...
//                 <h3 className="text-lg font-semibold text-foreground">Laporan Status Pembayaran</h3>
//                 <Button onClick={handleExport} size="sm" className="bg-emerald-600 hover:bg-emerald-700 text-white">
//                   <Download className="h-4 w-4 mr-2" />
//                   Export Excel
//                 </Button>
//               </div>
...
//                   <div>
//                     <h4 className="font-medium text-foreground">{item.nama}</h4>
//                     <p className="text-sm text-muted-foreground">{selectedPeriod}</p>
//                   </div>
//                 </div>
//                 <div className="space-y-2 text-sm">
//                   <div className="flex justify-between">
//                     <span className="text-muted-foreground">Tgl Pengecekan:</span>
//                     <span>{item.meterSaatPengecekan}</span>
//                   </div>
//                   <div className="flex justify-between">
//                     <span className="text-muted-foreground">Meter:</span>
//                     <span>
//                       {item.tagihan} | Pemakaian: {item.tagihan}
//                     </span>
//                   </div>
//                   <div className="flex justify-between">
...
//                     <span>Rp {item.abonemen.toLocaleString("id-ID")}</span>
//                   </div>
//                   <div className="flex justify-between">
...
//                     <span>Rp {(item.totalTagihan - item.belumBayar).toLocaleString("id-ID")}</span>
//                   </div>
//                   <div className="flex justify-between">
//                     <span className="text-muted-foreground">Belum Baya:</span>
//                     <span className="font-medium">
//                       Rp {item.belumBayar > 0 ? item.belumBayar.toLocaleString("id-ID") : "0"}
//                     </span>
//                   </div>
//                 </div>
...
export default function LaporanStatusPembayaranPage() {
  ...
  function labelSisaKurang(n: number) {
    ...
    if (n < 0) return `Lebih Rp ${fmtRp(-n)}`;
    return "Lunas";
  }
  ...
  const footerTotals = useMemo(
    () => ({
      ...
      sisaKurang: fmtRp(summary.sisaKurang),
    }),
    [summary]
  );
              ...
              <GlassCard className="p-4">
                <div className="text-sm space-y-1">
                  ...
                  {/* <div className="flex justify-between">
                    ...
                    <b className="">Rp {footerTotals.sisaKurang}</b>
                  </div> */}
                </div>
              </GlassCard>
            )}
