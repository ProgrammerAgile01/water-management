              ...
              <div className="space-y-3 mb-4">
                ...
                <div className="space-y-1 text-sm">
                  ...
                  <div className="pl-2 space-y-1">
                    ...
                    {/* {(() => {
                      const credit = parseCredit(b.info);
                      if (!credit) return null;
                      return (
                        <div className="pl-2 pt-1 text-xs text-blue-700">
                          Lebih bayar {fmtRp(credit)} (otomatis mengurangi
                          tagihan berikutnya)
                        </div>
                      );
                    })()} */}
