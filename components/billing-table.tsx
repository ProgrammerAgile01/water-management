...
//   return ps.map((p) => formatPeriode(p)).join(", ");
// }
...
//   // ← status FE: jika ada CLOSED_BY maka lunas; else pakai sisaKurang/field status
...
//       // ⬇️ STATUS TIDAK DIKIRIM KE API (filter di FE)
//       if (debouncedQ) qs.set("q", debouncedQ);
//       // pagination biarkan server-side (opsional), tapi kita akan paginate ulang di FE
//       qs.set("page", String(1));
//       qs.set("perPage", String(1000)); // ambil cukup banyak agar FE bebas paginate
...
/* =========================
   PAYMENT PROOF MODAL (FIXED & smaller on mobile)
========================= */
      ...
      <DialogContent className="max-w-[92vw] md:max-w-4xl p-4 md:p-6">
        ...
        {selected ? (
          <div className="grid gap-3 md:gap-4 md:grid-cols-2">
            ...
            {/* RIGHT: Gambar (diperkecil di mobile) */}
